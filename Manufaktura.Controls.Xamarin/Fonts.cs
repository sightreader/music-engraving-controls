...
namespace Manufaktura.Controls.Xamarin
{
	public static class Fonts
	{
		private static Dictionary<MusicFontStyles, FontInfo> _fonts = new Dictionary<MusicFontStyles, FontInfo>()
			{
				{MusicFontStyles.MusicFont, new FontInfo(PolihymniaFamily, 27.5)},
				{MusicFontStyles.GraceNoteFont, new FontInfo(PolihymniaFamily, 20)},
				{MusicFontStyles.StaffFont, new FontInfo(PolihymniaFamily, 30.5)},
		...
		private static string PolihymniaFamily = "Polihymnia";
